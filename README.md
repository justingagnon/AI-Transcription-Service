...
- **Example 1:** test01_20s
A short voice segment reciting a poem showing timestamp accuracy.

- **Example 2:** pdaLR
A longer audio file capturing a business meeting with several people.
